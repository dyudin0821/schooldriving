...
$(document).ready(function () {
    ...
    map.addMarker({
        ...
        title: 'автошкола "Альтернатива"',
        infoWindow: {
            content: '<p>автошкола "Альтернатива"<br> Обучение водителей категорий "А" и "В"<br> пр.Энгельса 136 к1, секция: 68 <br><a href="tel://+7 (812) 920-0410">тел.:+7 (812) 920-0410</a></p>'
        }
    });
});